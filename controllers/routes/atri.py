...
class Atri:
	def __init__(self, state: Any):
		...
		self.AreaChart1 = state["AreaChart1"]
		self._setter_access_tracker = {}
	...
	@property
	def AreaChart1(self):
		self._getter_access_tracker["AreaChart1"] = {}
		return self._AreaChart1
	@AreaChart1.setter
	def AreaChart1(self, new_state):
		self._setter_access_tracker["AreaChart1"] = {}
		global default_state
		self._AreaChart1 = AreaChart(new_state, default_state["AreaChart1"])

	def _to_json_fields(self):
		return {
			"Carousel1": self._Carousel1,
			"Image1": self._Image1,
			"AreaChart1": self._AreaChart1,
			}
...
class AreaChartcustomClasscartesianGridClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class AreaChartcustomClassxAxisClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class AreaChartcustomClassyAxisClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class AreaChartcustomClasstoolTipClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class AreaChartcustomClasslegendClass:
	def __init__(self, state, def_state):
		self._setter_access_tracker = {}
		self._def_state = def_state
...
class AreaChartcustomClass:
	def __init__(self, state, def_state):
		...
		self.cartesianGrid: AreaChartcustomClasscartesianGridClass = get_defined_value(state, def_state, "cartesianGrid")
		self.data: List[Any] = get_defined_value(state, def_state, "data")
		self.xAxis: AreaChartcustomClassxAxisClass = get_defined_value(state, def_state, "xAxis")
		self.yAxis: AreaChartcustomClassyAxisClass = get_defined_value(state, def_state, "yAxis")
		self.toolTip: AreaChartcustomClasstoolTipClass = get_defined_value(state, def_state, "toolTip")
		self.legend: AreaChartcustomClasslegendClass = get_defined_value(state, def_state, "legend")
	...
	def cartesianGrid(self, state):
		...
		self._cartesianGrid = AreaChartcustomClasscartesianGridClass(state, self._def_state["cartesianGrid"])
	@property
	def data(self):
	...
	def xAxis(self, state):
		...
		self._xAxis = AreaChartcustomClassxAxisClass(state, self._def_state["xAxis"])
	@property
	def yAxis(self):
	...
	def yAxis(self, state):
		...
		self._yAxis = AreaChartcustomClassyAxisClass(state, self._def_state["yAxis"])
	@property
	def toolTip(self):
	...
	def toolTip(self, state):
		...
		self._toolTip = AreaChartcustomClasstoolTipClass(state, self._def_state["toolTip"])
	@property
	def legend(self):
	...
	def legend(self, state):
		...
		self._legend = AreaChartcustomClasslegendClass(state, self._def_state["legend"])
	@property
	def options(self):
...
class AreaChart:
	def __init__(self, state, def_state):
		...
		self.styles: AreaChartstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: AreaChartcustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = AreaChartstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = AreaChartcustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
